...
namespace OnlineShoppingSystem.Helpers
{
    public static class Utils
    {
        ...
        public static string GetFormattedExceptionDetails(Exception exception)
        {
            ...
            return $"Class: {className} | Function: {methodName} | Error Message: {exception.Message}";
        }
        /// <summary>
        ...
        /// </remarks>
        public static void ValidateRequiredFields(List<string> requiredFields, object obj)
        {
